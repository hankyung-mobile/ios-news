...
class NewsPageViewModel {
    ...
    // 마스터 데이터 상태를 UI에 노출
    let newsData: Driver<[NewsSlideItem]>
    ...
    init() {
        ...
        newsData = AppDataManager.shared.newsData
    ...
    private func setupMasterDataObserver() {
        AppDataManager.shared.newsData
    ...
    private func updateUrls(from slideData: [NewsSlideItem]) {
