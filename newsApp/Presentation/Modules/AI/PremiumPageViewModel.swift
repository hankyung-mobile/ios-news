...
class PremiumPageViewModel {
    ...
    // 프리미엄 데이터 상태를 UI에 노출
    let premiumData: Driver<[PremiumSlideItem]>
    ...
    init() {
        ...
        premiumData = AppDataManager.shared.premiumData
    ...
    private func setupMasterDataObserver() {
        AppDataManager.shared.premiumData
    ...
    private func updateUrls(from slideData: [PremiumSlideItem]) {
