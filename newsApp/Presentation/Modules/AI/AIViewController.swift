...
class AIViewController: UIViewController {
    ...
    private let urlString = "https://stg-webview.hankyung.com/ai-search"
    ...
    private func setupWebContentController() {
        ...
        guard let url = URL(string: "https://\(customUrl)webview.hankyung.com/ai-search") else {
...
extension AIViewController: WebNavigationDelegate {
