//
//  EditReportersControllerTableViewCell.swift
//  newsApp
//
...
class EditReportersControllerTableViewCell: UITableViewCell {
...
//        layer.borderColor = UIColor.clear.cgColor
    ...
    private func loadImage(from urlString: String) {
        ...
        if let cachedImage = EditReportersControllerTableViewCell.imageCache.object(forKey: cacheKey) {
        ...
        imageTask = URLSession.shared.dataTask(with: url) { [weak self] data, response, error in
            DispatchQueue.main.async {
                ...
                // 캐시에 저장
                EditReportersControllerTableViewCell.imageCache.setObject(image, forKey: cacheKey)
